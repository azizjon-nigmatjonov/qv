...
export function InstructionsList() {
  ...
  const submittedToUse = {
    ...
    key: 2,
    count: getClaimOrganizationActionsQuery.data?.data?.count,
    component: (
      <BasicTable
  ...
  return (
    <div className="h-screen">
      <Header
        title={`${pathname.startsWith('/instructions') ? 'Tasdiqlashda' : ''}`}
        backLink="/inspectors"
        centerElement={!pathname.startsWith('/instructions') && <Tabs elements={tabLinks} />}
      />
            ...
            <MuiTabs
              ...
              elements={
                ...
                [...tabElements, submittedToUse, shaffofTab].slice(
                  0,
                  pathname.startsWith('/instructions') ? (isTexnik || isMuallif ? 3 : 2) : 2
                )
              }
