// 29.Журнал>регистрации вводного инструктажа по охране труда (RU-UZ)
...
export const tables = ({ control, register, onChange }) => [
  {
    ...
    name: 'introductory_briefing',
    title: 'регистрации вводного инструктажа по охране труда (RU-UZ)',
    hasDates: true,
  },
]
